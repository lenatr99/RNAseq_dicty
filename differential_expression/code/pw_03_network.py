...
for strain in strains:
    ...
    for INDEX in range(len(SETS)):
        ...
        all_communities_kcore[strain][TERM] = {}
        all_communities_desc[strain][TERM] = {}
        for hour in hours:
            (
                graph,
                communities,
                ...
                communities_kcore_desc,
                graph_layout,
            ) = generate_graph_data(strain, hour, GENE_SET, TERM)
            all_graph_data[(strain, hour, GENE_SET, TERM)] = graph
            all_communities[(strain, hour, GENE_SET, TERM)] = communities
            all_graph_data_cc[(strain, hour, GENE_SET, TERM)] = graph_cc
            all_communities_cc[(strain, hour, GENE_SET, TERM)] = communities_cc
            all_communities_kcore[strain][TERM][str(hour)] = communities_kcore
            all_communities_desc[strain][TERM][str(hour)] = communities_kcore_desc
            all_graph_layout[(strain, hour, GENE_SET, TERM)] = graph_layout
